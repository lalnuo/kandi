...
\abstract{Tämän kandidaatintutkielman päätavoite on selvittää kuinka SQL-injektioilta voidaan suojautua. Tutkielman ensimmäisessä osassa esitellään mikä on SQL-injektio. Perusteiden lisäksi esitellään kuinka SQL-injektioita voidaan luokitella, sekä kuinka hyökkääjä voi yrittää naamioida hyökkäyksensä kiertääkseen palomuureja.

Seuraavaksi esitellään kuinka SQL-injektioilta voidaan suojautua. Osa menetelmistä suojaa sovelluksen täysin, kun taas osa vaikeuttaa SQL-injektion suorittamista. Osa menetelmistä on mahdollista lisätä erillisenä moduulina valmiiseen sovellukseen, kun taas osan menetelmistä lisääminen myöhemmässä vaiheessa on työlästä.

Tutkielman viimeisessä osassa esitellään kuinka sovellusta voidaan penetraatiotestata. Penetraatiotestauksen avulla ei voida olla varmoja sovelluksen turvallisuudesta. Penetraatiotestaamalla voidaan kuitenkin löytää SQL-injektio aukkoja, joita ei manuaalisesti testattaessa löydettäisi.
}

% The following can be used to specify keywords and classification of the paper:

\keywords{SQL-injektio, tietoturva, penetraatiotestaus, AMNESIA, SQL-IDS, SQLRand, V1p3R}
