...
\abstract{Tämän kandidaatintutkielman päätavoite on selvittää millaisin keinoin SQL-injektiolta voidaan suojautua. Tutkielma koostuu seuraavista osa-alueista: SQL-injektion esittely, tietoturvallisen ohjelman toteutus, ajonaikainen SQL-injektioiden estäminen ja penetraatiotestaus. 
